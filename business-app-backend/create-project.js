...
async function main() {
  ...
  try {
    ...
    const projectNameUpperSnake = projectNameSnake.toUpperCase(); // For entity code (e.g., INVENTORY_MANAGEMENT)
    ...
    const replacements = {
      ...
      // Update entity code for auth-service (used in login and logging)
