...
/**
 * Global exception handler for the business application.
 *
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles resource not found exceptions (user, product, entity not found).
     *
    ...
    /**
     * Handles external service exceptions (auth-service failures, API unavailability).
     *
     ...
     * <p>Common scenarios:
     * <ul>
     *   <li>Duplicate product name (unique constraint violation)</li>
